...
def main() :
    ...
    fakeUser=['Rosario M','Maria L','Maria T','detectivetravel','StefanoTDM S','laura p','Azhaar A','Nikki H','Massimo D','Salvatore S','Mario Cartello','vicarioma','Ilaria B','Alessandro Surico','Stefania T','usseglio','Alessandro','butteflyvale','Laura S','Rossella']
